...
package com.drem.heartbeat.common;
 ...
 * event notification methods to appropriate Event Listeners on the list. The
 * main benefits that this class provides are that it is relatively cheap in the
 * case of no listeners, and it provides serialization for event-listener lists
 * in a single place, as well as a degree of MT safety (when used correctly).
...
public class EventListenerList implements Serializable {
	private static final long serialVersionUID = -374845298068852567L;
     ...
     * Object should be returned if there are currently no listeners. WARNING!!!
     * Absolutely NO modification of the data contained in this array should be
     * made -- if any such manipulation is necessary, it should be done on a
     ...
     * @exception ClassCastException if the supplied class is not assignable to
     *                EventListener
     * @since 1.3
     */
